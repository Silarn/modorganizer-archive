...
#include "archive/inputstream.h"
#include "archive/opencallback.h"
...
QString FileDataImpl::getFileName() const { return m_FileName; }

void FileDataImpl::addOutputFileName(const QString& fileName) { m_OutputFileNames.push_back(fileName); }
...
extern "C" DLLEXPORT Archive* CreateArchive() { return new ArchiveImpl; }
