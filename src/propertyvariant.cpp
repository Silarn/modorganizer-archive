...
PropertyVariant::PropertyVariant() { PropVariantInit(this); }

PropertyVariant::~PropertyVariant() { clear(); }

void PropertyVariant::clear() { PropVariantClear(this); }
...
template <>
PropertyVariant::operator QString() const {
    switch (vt) {
    case VT_EMPTY:
        return "";
